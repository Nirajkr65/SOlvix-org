...
function HomePage() {
  ...
  return (
    <div className="min-h-screen bg-[#050505] text-white p-6 relative overflow-hidden selection:bg-emerald-500/30 bg-[radial-gradient(ellipse_at_top,_var(--tw-gradient-stops))] from-zinc-900 via-black to-black">
      ...
      <div className="max-w-7xl mx-auto relative z-10 space-y-8 pb-12">
        ...
        <div className="flex flex-col md:flex-row justify-between items-end gap-6 border-b border-white/10 pb-8 mt-4">
          <div className="space-y-2">
            <h1 className="text-5xl font-bold bg-linear-to-r from-white via-zinc-200 to-zinc-500 bg-clip-text text-transparent flex items-center gap-3">
        ...
        <div className="sticky top-4 z-40 bg-black/80 backdrop-blur-xl border border-white/10 p-4 rounded-2xl shadow-2xl flex flex-col lg:flex-row gap-4 justify-between items-center transition-all">
          ...
          <div className="flex flex-wrap gap-3 w-full lg:w-auto justify-end">
            ...
            {/* Tags Filter */}
            <select
              className="bg-white/5 border border-white/10 text-zinc-300 text-sm rounded-xl focus:ring-emerald-500 focus:border-emerald-500 block p-2.5 outline-none hover:bg-white/10 transition-colors cursor-pointer capitalize backdrop-blur-md"
              value={filters.tags}
              ...
              {filteredProblems.map((problem) => {
                ...
                return (
                  <NavLink
                    ...
                    className="group relative bg-black/40 hover:bg-white/[0.07] border border-white/10 rounded-xl p-4 transition-all duration-300 hover:shadow-xl hover:shadow-emerald-500/5 flex flex-col md:flex-row items-start md:items-center justify-between gap-4 overflow-hidden backdrop-blur-sm"
                  >
                    {/* Hover Gradient Overlay */}
                    <div className="absolute inset-0 bg-linear-to-r from-emerald-500/5 via-transparent to-transparent opacity-0 group-hover:opacity-100 transition-opacity pointer-events-none" />
