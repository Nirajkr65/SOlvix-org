            ...
            <div className="relative z-10">
                ...
                <section className="pt-15 pb-10 px-6 md:px-12 max-w-7xl mx-auto text-center">
                    ...
                    <p className="text-lg md:text-xl text-zinc-400 max-w-2xl mx-auto leading-relaxed">
                        SOLVIX is the ultimate platform to practice coding problems,
                    ...
                    <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
                        <Link
                            to="/signup"
                            className="px-8 py-4 rounded-xl bg-white text-black font-bold text-lg transition-all hover:scale-105 hover:shadow-lg hover:shadow-white/20 w-full sm:w-auto flex items-center justify-center gap-2 group"
                        >
                            Get Started
                        </Link>
                        <Link
                            to="/problems"
                            className="px-8 py-4 rounded-xl bg-white/5 border border-white/10 hover:bg-white/10 text-white font-bold text-lg transition-all backdrop-blur-md w-full sm:w-auto flex items-center justify-center gap-2 group"
                        >
                            Explore Problems
