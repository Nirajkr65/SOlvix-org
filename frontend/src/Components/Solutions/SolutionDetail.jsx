            ...
            <div className="flex-1 overflow-y-auto p-6 scrollbar-thin scrollbar-thumb-white/10">
                ...
                <div className="space-y-6">
                    ...
                    <div className="flex gap-3">
                        <div className="w-8 h-8 rounded-full bg-linear-to-tr from-blue-500 to-purple-500 flex items-center justify-center text-xs font-bold text-white shrink-0">
                        ...
                        <div className="flex-1">
                            <textarea
                                ...
                                className="w-full bg-transparent border-b border-white/10 focus:border-emerald-500 outline-none text-zinc-300 text-sm py-2 min-h-10 transition-colors resize-none"
                            />
