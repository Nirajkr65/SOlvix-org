...
function App() {
  ...
  const [showSplash, setShowSplash] = useState(() => {
    // Show splash only if it hasn't been shown in this session
    return !sessionStorage.getItem("solvix_splash_shown");
  });

  const handleSplashFinish = () => {
    setShowSplash(false);
    sessionStorage.setItem("solvix_splash_shown", "true");
  };
