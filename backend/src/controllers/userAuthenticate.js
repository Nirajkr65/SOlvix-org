...
const sendVerificationOtp = async (req, res) => {
    try {
        ...
        await sendEmail({
            to: user.emailId,
            subject: "Verify your email - SOLVIX",
            html: `
                <div style="font-family: Arial, sans-serif; padding: 20px; border: 1px solid #e0e0e0; border-radius: 10px; max-width: 500px;">
                    <h2 style="color: #10b981; text-align: center;">SOLVIX</h2>
                    <p style="font-size: 16px; color: #333;">Hello,</p>
                    <p style="font-size: 16px; color: #333;">Your verification code for <strong>SOLVIX</strong> is:</p>
